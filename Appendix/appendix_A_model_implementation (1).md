...
Collector stage is expressed as head above the model reference elevation of
67.0 m a.s.l. (`BASE_GWL` in the code); this reference is not the collector base
elevation given in Table 1 of the paper.
...
| Exponent of the capillary relation | `AVERYANOV_N` | 1.88 | set to reproduce the measured capillary contribution at comparable water-table depths (Appendix B.1) |
...
|---|---|---|
| Storage coefficient | `STORAGE_COEFF` | 0.078 |
